...
const cookieName = '劲友家小程序'

const moliyadi = init()

if ($request && $request.method == 'GET' && $request.url.indexOf('jjw.jingjiu.com/app-jingyoujia/app/jingyoujia/customer/detail') >= 0) {
