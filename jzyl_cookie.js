const cookieName = '健走有礼'

const moliyadi = init()

if ($request && $request.method == 'GET' && $request.url.indexOf('bwa.feierlaiedu.com/api/v1/bbg/taskRecord/queryUserInfo') >= 0) {
    ...
    (err,res,data)=>{
      eval(data)
      update(token,'jzylCookie',cookieName,'\n')
